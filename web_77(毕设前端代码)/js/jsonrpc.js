...
//system.listMethods is a test function without parameters
	...
	catch (e) {if (e==JSONRpcClient.Exception.CODE_ERR_CLIENT)
	{
		alert("Not connected!");
	}}
...
//added by zxz
    if (!m)
    {
       Ext.Msg.alert("Alarm","No response");
       return;
    }
